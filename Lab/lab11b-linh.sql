...
--Function : take an input and evaluate it with no side effects
...
select 'Linh''s age', dbo.GetAge('19971021', getdate());
select 'Linh''s age', dbo.GetAge('19971021', '20201023');
...
go
CREATE TRIGGER trg_T1_insert_audit ON dbo.T1 AFTER INSERT, delete
AS
SET NOCOUNT ON;
...
delete from dbo.t1 where keycol = 10;
update dbo.T1 set datacol = 'h' where keycol = 20;
GO
